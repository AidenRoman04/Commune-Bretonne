...
public class ScénarioTest {
    ...
    /**
     * test de la méthode getAverageRate
     */
    @Test
    public void testGetAverageRate() {
        System.out.println("Test de la méthode getAverageRate de la classe Year");
        Year y = new Year(2020, 0.02);
        HashMap<String, Float> rates = new HashMap<String, Float>();

        rates.put("Paris", 0.02f);
        rates.put("Niort", 0.01f);
        rates.put("Vannes", 0.03f);

        testCasGetAverageRate(rates, 0.02);

        System.out.println("");
    }

    public void testCasGetAverageRate(HashMap<String, Float> rates, double expected) {
        System.out.println("Test de la méthode getAverageRate");
        double result = 0;

        result = rates.get(2020).getAverageRate();
