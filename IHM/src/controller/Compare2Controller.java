...
public class Compare2Controller {
    ...
    private void plotData() {
        ...
        plotCityData(city1.getValue(), city1.getValue(), selectedVariable);
        plotCityData(city2.getValue(), city2.getValue(), selectedVariable);
        plotCityData(city3.getValue(), city3.getValue(), selectedVariable);
    }
